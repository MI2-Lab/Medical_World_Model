#!/usr/bin/env python3
"""Validate or aggregate the complete 60-cell pilot into Tables 1-7/Figures 1-10."""
...
PILOT_METRICS_ROOT = EXPERIMENT_ROOT / "metrics"
PILOT_FIGURE_ROOT = EXPERIMENT_ROOT / "figures"
STAGE_A_RELATIVE = "additional_experiments/c1b_overlap_eligibility_ftv_stageb/STAGE_A_GO.json"
...
def main() -> None:
    ...
    if Path(str(getattr(pilot_security, "__file__", ""))).resolve() != (
        ...
        raise ImportError("pilot security module was shadowed before aggregation")
    ...
    postprocessing_completion_path = (
        probe_root / "postprocessing_complete.private.json"
    )
    try:
    ...
    source_provenance = {
        ...
        "stage_a_sentinel_sha256": preregistration["upstream_sha256"][
            STAGE_A_RELATIVE
        ],
