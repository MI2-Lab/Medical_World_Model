...
class MatrixTest(unittest.TestCase):
    ...
    def test_exact_inventory_order_pairing_and_three_gpu_assignment(self) -> None:
        self.assertEqual(matrix.FORMAL_ARM_ORDER, (
            "GAP0", "GAP3", "LOCAL0", "LOCAL3", "LG0", "LG3"
        ))
        ...
        self.assertEqual(len({(cell.seed_base, cell.fold, cell.arm) for cell in cells}), 60)
        self.assertEqual(
        ...
        for group in self.groups:
            ...
            for baseline in ("GAP0", "LOCAL0", "LG0"):
