...
from c1b_stage_b.contracts import ARMS, ordered_patient_sha256, validate_seed_fold  # noqa: E402
...
def main() -> None:
    ...
    data = load_stage_b_data(paths, verify_cache_files=False)
    effective_seed = validate_seed_fold(args.seed_base, args.fold)
    splits = make_splits(data.folds, args.fold, data.eligible_ispy1)
