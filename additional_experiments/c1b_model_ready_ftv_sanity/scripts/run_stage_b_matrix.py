...
def main() -> None:
    ...
    data = load_stage_b_data(paths, verify_cache_files=True)
    ...
    preflight = {
        ...
        "primary_patients": int(data.folds["patient_id"].nunique()),
        "eligible_ispy1_train_only_patients": len(data.eligible_ispy1),
        "cache_preflight": {
