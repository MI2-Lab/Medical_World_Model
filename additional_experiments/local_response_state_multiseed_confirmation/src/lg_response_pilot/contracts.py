"""Frozen arm and geometry contracts for LOCAL multi-seed confirmation."""
...
def arm_spec(arm: str) -> ArmSpec:
    ...
    if name not in ARM_SPECS:
        raise ValueError(f"confirmation arm must be one of {ARMS}; got {arm!r}")
